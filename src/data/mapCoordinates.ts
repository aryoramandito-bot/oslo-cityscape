...
export const mapCoordinates = {
  ...
  // Laweyan Sites (lw1 - lw26)
  'lw1':  { x: 46, y: 38 },   // Makam Ki Ageng Henis
  'lw2':  { x: 47, y: 36 },   // Masjid Laweyan
  'lw3':  { x: 54, y: 52 },   // Lorong Gang Senggol
  'lw4':  { x: 52, y: 57 },   // Rumah KH Samanhudi & Syarikat Dagang Islam
  'lw5':  { x: 55, y: 48 },   // Ndalem Tjokrosoemartan
  'lw6':  { x: 58, y: 45 },   // Roemahkoe Heritage
  'lw7':  { x: 49, y: 55 },   // Batik Gunawan Setiawan & Workshop
  'lw8':  { x: 43, y: 49 },   // Batik Putra Laweyan
  'lw9':  { x: 57, y: 61 },   // Batik Mahkota Laweyan
  'lw10': { x: 39, y: 26 },   // Bandar Kabanaran
  'lw11': { x: 47, y: 64 },   // Monumen & Situs Samanhudi
  'lw12': { x: 61, y: 51 },   // Batik Merak Manis
  'lw13': { x: 63, y: 56 },   // Batik Cempaka Heritage House
  'lw14': { x: 50, y: 50 },   // Sentra FPKBL
  'lw15': { x: 48, y: 43 },   // Apem Mencon Laweyan
  'lw16': { x: 47, y: 53 },   // Ledre Laweyan
  'lw17': { x: 82, y: 64 },   // Es Gempol Pleret Pak Suhar
  'lw18': { x: 53, y: 58 },   // Selat Solo Mbok Giok
  'lw19': { x: 66, y: 70 },   // Soto Seger Mbok Giyem Laweyan
  'lw20': { x: 54, y: 46 },   // Warung Makan Ibu Ruth
  'lw21': { x: 51, y: 41 },   // Kue Moho & Onde-Onde Laweyan
  'lw22': { x: 77, y: 32 },   // Gudeg Mbak Yus
  'lw23': { x: 82, y: 37 },   // Sate Kere Yu Rebi
  'lw24': { x: 55, y: 66 },   // Wedangan HIK Radjiman Laweyan
  'lw25': { x: 51, y: 47 },   // Kopi Laweyan
  'lw26': { x: 63, y: 22 }    // Dapur Solo Resto & Gallery Laweyan
