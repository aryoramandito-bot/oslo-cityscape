...
export default function BottomNav() {
  ...
  return (
    /* Pill-Shaped Hanging Toolbar (Floating Liquid Glass Island) */
    <nav className="fixed bottom-3 left-4 right-4 max-w-sm mx-auto h-16 rounded-full bg-white/60 backdrop-blur-2xl backdrop-saturate-200 border border-white/70 shadow-[0_16px_40px_rgba(28,25,23,0.12),inset_0_1.5px_1.5px_rgba(255,255,255,0.95),inset_0_-1px_1px_rgba(255,255,255,0.35)] ring-1 ring-stone-900/5 px-2 flex items-center justify-between z-40 select-none overflow-hidden">
