      ...
      <div className="p-4 rounded-3xl bg-white border border-gray-200/80 shadow-xs flex items-center justify-between">
        <div>
          ...
          <h2 className="text-base font-bold text-gray-900 font-outfit mt-0.5">
            {activeCity === 'laweyan' ? 'Laweyan Heritage & Workshop Schedule' : activeCity === 'solo' ? 'Solo Heritage & Festival Schedule' : activeCity === 'bandung' ? 'Bandung Festival Schedule' : 'Jakarta Daily Happenings'}
          </h2>
